  ...
  return (
    <div className="flex flex-1">
      ...
      <div className=" flex-1 bg-[white]  ">
        <div className="mt-[85px] ml-[70px] p-[20px] bg-[#E5ECF3] min-h-[90vh] flex justify-center   rounded-tl-[20px]">
          {curValue === 0 ? (
            <div className="pc:w-[50%] tablet:w-[70%] w-[95%] py-4  flex flex-col">
              ...
              {loadingData || !blogDetail ? (
                ...
                <div className="flex  flex-col gap-6">
                  ...
                  <div className="flex  justify-end gap-4">
                    <Button
                      onClick={() =>
                        navigate(isLoggedIn ? `/edit-blog/${id}` : "/login")
                      }
                  ...
                  <div className="w-full">
                    <img
                      ...
                      alt={blogDetail.title || "cover Image Url"}
                    />
                  </div>
                  <div className=" tablet:px-10 flex flex-col gap-5">
                    ...
                    <div className=" rounded-[12px] p-[12px] flex flex-col gap-[8px] bg-[white]">
                      <h1 className="font-[700] text-[24px] leading-[28.8px]">
                        Conclusion
                        <span className="rotated-letter text-[22px] ml-1">
                          ✏️
                        </span>
                      </h1>
              ...
              <>
                {loadingComments ? (
                  ...
                  <div className="tablet:px-10 mt-7 ">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                      <span className="font-[700] md:font-[800] text-[25px] md:text-[32px] leading-[38.4px]">
                        Comments
                      </span>
                      <Button
                        onClick={() => setIsPopupOpen(true)}
                        className="bg-gradient-to-r from-blue-500 to-blue-700 text-white md:font-bold py-1 px-2 md:px-4 rounded-lg shadow-lg hover:from-blue-600 hover:to-blue-800 transition duration-300 ease-in-out"
                      >
                        Give Comment
                      </Button>
                    </div>
                    <div>
                      {comments && comments.length === 0 ? (
                        <div className=" w-full mt-[40px] font-[500] text-[19px] tablet:text-[30px] flex justify-center ">
